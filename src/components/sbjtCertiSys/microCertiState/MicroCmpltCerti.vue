<template>
  <v-col cols="12">
    <div class="my-4 text-h4 inside">마이크로디그리 인증 선택</div>
    ...
    <BaseCard :title="'검색'">
      ...
      <div class="d-flex pt-4 justify-end">
        ...
        <v-btn variant="flat" color="primary" width="80" v-on:click="fnGetCmpltCert">검색</v-btn>
      </div>
    </BaseCard>
  </v-col>
  <v-col>
...
export default {
  ...
  methods: {
    ...
    fnGetCmpltCert() {
      ...
      vm.$axios
        .get("/api/certification/admin/subject/getCmpltCertList", { params: param })
        .then((res) => {
