<template>
  <v-col cols="12">
    <div class="my-4 text-h4 d-inline">마이크로디그리 인증 선택</div>
    ...
    <BaseCard :title="'검색'">
      ...
      <div class="d-flex pt-4 justify-end">
        ...
        <v-btn variant="flat" color="primary" width="80" v-on:click="fnGetCertiState">검색</v-btn>
      </div>
    </BaseCard>
  </v-col>
  <v-col>
    <BaseCard>
      <BaseTableConfig :totalCnt="list.length" @update:rowPerPage="updateRowPerPage">
...
export default {
  data() {
    return {
      ...
      items: [
        { title: "대학/학과/학생명", value: "" },
        { title: "대학", value: "colg" },
        { title: "학과", value: "hakgua" },
        { title: "학생명", value: "userNm" },
      ],
      selectedItem: "",
      comboboxOption1: {
  ...
  methods: {
    ...
    fnGetCertiState() {
      ...
      vm.$axios
        .get("/api/certification/admin/subject/getCeriStateList", { params: param })
        .then((res) => {
