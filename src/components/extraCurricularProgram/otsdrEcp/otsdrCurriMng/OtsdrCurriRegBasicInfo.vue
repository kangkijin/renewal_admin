      ...
      <v-col cols="12">
        <v-table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <v-text-field placeholder="과정명을 입력해주세요."></v-text-field>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <v-text-field placeholder="이수증 발급 명의를 입력해주세요."></v-text-field>
              </td>
            </tr>
            <tr>
        ...
        <div class="d-flex justify-end pt-4">
          <v-btn
            ...
            width="80"
            class="mr-2"
            to="/admin/extraCurricularProgram/otsdrEcp/otsdrCurriMng"
            >취소</v-btn
          >
