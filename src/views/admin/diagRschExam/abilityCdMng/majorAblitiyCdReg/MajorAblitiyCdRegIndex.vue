                    ...
                    <v-col cols="3">
                      <v-container class="py-2">
                        <span class="font-weight-medium">
                          {{ selectedAbility.cdNm == "" ? "전공능력을 선택해주세요." : selectedAbility.cdNm }}
                        </span>
                      </v-container>
                    </v-col>
                    <v-col cols="9">
...
export default {
  ...
  methods: {
    ...
    fnGetAbilityCd() {
      ...
      vm.$axios
        .get("/api/admin/diag/abilityCdMng/getMajorAbilityInfo")
    ...
    fnExcelDown() {
      ...
      const headers: Header[] = [
        ...
        { header: "학과명", key: "cdNm", width: 30 },
        { header: "학과코드명", key: "cdId", width: 15 },
        { header: "전공능력코드", key: "childrenCdId", width: 30 },
        { header: "전공능력코드명", key: "childrenCdNm", width: 15 },
        { header: "전공능력코드설명", key: "childrenCdDesc", width: 40 },
      ];
