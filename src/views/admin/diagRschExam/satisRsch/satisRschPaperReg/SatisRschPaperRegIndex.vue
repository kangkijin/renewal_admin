        ...
        <v-col>
          <BaseCard>
            <template v-slot:title>
              <div class="d-flex align-center">
                <div class="text-h4">만족도 조사지 목록</div>
                <!-- tooltip -->
            ...
            <BaseTableConfig :totalCnt="list.length">
              <template #top-btn-area>
                ...
                <v-btn color="grey" @click="onClickPlanForm('REG', '')">조사지 생성</v-btn>
              </template>
            ...
            >
              ...
              <template #item-diagMng="item">
                <v-btn size="small" :disabled="item.useYn == 'N'" @click="onClickPlanForm('MODIFY', item.diagKey)">
                  수정
                </v-btn>
                <!-- 진단 미리보기 -->
