<template>
  ...
  <v-row>
    <v-col cols="12">
      ...
      <v-row>
        <v-col>
          <BaseCard title="전공능력진단 실시계획 목록">
            <BaseTableConfig :totalCnt="list.length">
              <template #left-btn-area>
                <div class="mr-2">{{ selectMajorDiag.length }}개 선택</div>
            ...
            <v-easy-table
              ...
              v-model:items-selected="selectMajorDiag"
            >
    ...
    list: [
      {
        no: "1",
        diagKey: "MAJOR001",
        strPlanNm: "전공능력진단 2024",
        diagPaperNm: "전공능력진단 new",
