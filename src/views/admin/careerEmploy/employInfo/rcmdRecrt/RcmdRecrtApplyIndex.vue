        ...
        <v-table>
          ...
          <tbody>
            ...
            <tr>
              <th>상태</th>
              <td colspan="3">
                <v-radio-group inline v-model="searchInfo.userStsCd">
                  <v-radio label="전체" class="mr-4" value=""></v-radio>
                  <v-radio label="지원완료" class="mr-4" value="REC_USER_STS01"></v-radio>
                  <v-radio label="추천완료" class="mr-4" value="REC_USER_STS02"></v-radio>
                  <v-radio label="입사완료" class="mr-4" value="REC_USER_STS03"></v-radio>
                </v-radio-group>
              </td>
            </tr>
            <tr>
      ...
      <BaseCard>
        ...
        >
          <template #left-btn-area>
            <v-btn class="mr-2" @click="onClickStateCtrl('REC_USER_STS01')">지원</v-btn>
            <v-btn class="mr-2" @click="onClickStateCtrl('REC_USER_STS02')">추천</v-btn>
            <v-btn class="mr-2" @click="onClickStateCtrl('REC_USER_STS03')">입사</v-btn>
